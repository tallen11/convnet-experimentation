...
class ModelStandardV2(Model):
    def __init__(self, activation_func):
        ...
        with tf.device("/gpu:0"):
            ...
            W_conv1 = self.__weights([5,5,3,96])
            ...
            W_conv2 = self.__weights([5,5,96,128])
            ...
            W_conv3 = self.__weights([5,5,128,128])
            ...
            W_fc1 = self.__weights([4*4*128, 2048])
            b_fc1 = self.__biases([2048])
            h_pool3_flat = tf.reshape(h_pool3_dropout, [-1, 4*4*128])
